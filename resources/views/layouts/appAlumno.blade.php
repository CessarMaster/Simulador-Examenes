...
<head>
    ...
    <link href="http://localhost/Laravel/simulador/resources/css/CardExamenes.css" rel="stylesheet">
            ...
            <div>
                <nav class="bg-black border-gray-200 px-2 sm:px-4 py-2.5">
                    <div class="container flex flex-wrap justify-between items-center mx-auto">
                        <a href="{{route('alumno.index')}}" class="flex items-center">
                        ...
                        <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbarNav">
                            <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                                <li>
                                    <a href="{{route('alumno.index')}}" class="self-center text-xl font-semibold whitespace-nowrap text-white" aria-current="page">Inicio</a>
                                </li>
                                <li>
                                    <a href="{{route('alumno.examenes')}}" class="self-center text-xl font-semibold whitespace-nowrap text-white" aria-current="page">Examenes</a>
                                </li>
                                <li>
                                    <a href="{{route('alumno.resultados')}}" class="self-center text-xl font-semibold whitespace-nowrap text-white" aria-current="page">Resultados</a>
                                </li>
                            </ul>
                        </div>
                    </div>
